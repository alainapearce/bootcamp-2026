...
:::
::: {.column width=50%}
[Kyle Hallisky](https://libraries.psu.edu/directory/nmh5768) is a PhD candidate in the Department of Nutritional Sciences. His research uses functional neuroimaging to investigate the brain processes that influence eating behaviors in children. Through this work, he is committed to open science practices in neuroimaging, including transparent, reproducible analysis pipelines, responsible data sharing, and data publication that supports collaboration across the field.
:::
::::
